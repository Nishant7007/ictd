...
def getFinalDict(thisMonthMedianDict, sameMonthMedianDict):
	'''
	GIVEN TWO DICTS:
...
def getFinalDf(filesList, finalDict):
	...
	for i in range(len(filesList)):
		...
		fileToSave = filesList[i].replace('ORIGINAL', 'NormalOrAnomalous/SameMonth')
...
def checkPeriodsUsingSameMonth(commodity):
	'''
	...
	finalDict = getFinalDict(thisMonthMedianDict, sameMonthMedianDict)
	getFinalDf(filesList, finalDict)


checkPeriodsUsingSameMonth('POTATO')